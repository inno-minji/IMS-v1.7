...
//		}
    ...
    @RequestMapping("/cmm/fms/deleteFileInfs2.do")
    public void deleteFileInf2(@ModelAttribute("searchVO") FileVO fileVO, 
    		HttpServletRequest request,
    		HttpServletResponse response,
    		ModelMap model) throws Exception {
    	
    	fileVO.setAtchFileId(request.getParameter("atchFileId"));
    	fileVO.setFileSn(request.getParameter("fileSn"));
