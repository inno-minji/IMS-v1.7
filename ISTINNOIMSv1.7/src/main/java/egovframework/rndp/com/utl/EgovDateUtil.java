...
public class EgovDateUtil {
     ...
     */
    public static String addYearMonthDayType(String sDate, int year, int month, int day) {
    ...
    * @return 변환된 문자열
     ...
     * @return
     */
    public static List chkYearList(int sYear){
    	List chkYear = new ArrayList();
    	int year = Integer.parseInt(EgovDateUtil.getToday().substring(0, 4));
    	for(int i=year-sYear; i<=year; i++){
    		chkYear.add(i);
    	}
    	return chkYear;
    }
    ...
    public static int getMonth(){
    	int month = Integer.parseInt(EgovDateUtil.getToday().substring(4, 6));
    	return month;
    }
    
    public static int getDay(){
    	int day = Integer.parseInt(EgovDateUtil.getToday().substring(6, 8));
    	return day;
    }
    ...
    public static List getDayList(int day){
    ...
    // 15일 전 날짜
    public static String twoWeekDay(){
    	Calendar week = Calendar.getInstance();
    	week.add(Calendar.DATE, -15);
    	String beforeWeek = new java.text.SimpleDateFormat("yyyy-MM-dd").format(week.getTime());
    ...
    // 3달 전 날짜
    public static String threeMonthDay(){
    	Calendar month = Calendar.getInstance();
