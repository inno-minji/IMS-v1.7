...
function submitImageUploadForm(){
	...
	document.filefrm.action = "/smartImage2.do";
...
function closeWin() {
  parent.parent.oEditors.getById["content"].exec("SE_TOGGLE_IMAGEUPLOAD_LAYER");
  return false;
}


function fileAttach(name){ 
	var fname = document.filefrm.oldFileNm.value;
	parent.parent.insertIMG('content',fname);
	parent.parent.oEditors.getById['content'].exec("SE_TOGGLE_IMAGEUPLOAD_LAYER");
} 
