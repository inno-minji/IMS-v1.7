...
function chkIns(){
	with (document.frm)
	{
		...
		if (sEopcheGubun.selectedIndex == 0)
		{
			alert("구분을 선택하세요.");
			sEopcheGubun.focus();
			return  ;
		}
		if (sEopcheName.value == "")
		{
			alert("기업명을 입력하세요.");
			sEopcheName.focus();
			return false;
		...
		if (sEopcheBrn1.value == "" || sEopcheBrn2.value == "" || sEopcheBrn3.value == "")
		{
			alert("사업자번호을 입력하세요.");
			sEopcheBrn1.focus();
			return false;
		...
		if(isNaN(sEopcheBrn1.value)||isNaN(sEopcheBrn2.value)||isNaN(sEopcheBrn3.value)){
			alert("사업자 번호는 숫자만 입력하세요.");
			sEopcheBrn1.focus();
			return false;
		}
			
		if (sEopchePhone1.value == "" || sEopchePhone2.value == "" || sEopchePhone3.value == "")
		{
			alert("전화번호을 입력하세요.");
			sEopchePhone1.focus();
			return false;
		...
		if(isNaN(sEopchePhone1.value)||isNaN(sEopchePhone2.value)||isNaN(sEopchePhone3.value)){
			alert("전화번호는 숫자만 입력하세요.");
			sEopchePhone1.focus();
			return false;
		}
		
		if (sEopcheFax1.value == "" || sEopcheFax2.value == "" || sEopcheFax3.value == "")
		{
			alert("팩스번호을 입력하세요.");
			sEopcheFax1.focus();
			return false;
		...
		if(isNaN(sEopcheFax1.value)||isNaN(sEopcheFax2.value)||isNaN(sEopcheFax3.value)){
...
//목록으로
function cancle(){
	document.frm.action = "kw_Eopchepany_lf.jsp";
	document.frm.submit(); 
}
//담당차 추가  비고가 없을때 
var referIndex = 0;
...
//				);
		...
		innerStr+="<input type='hidden' id='eopcheItemKey' 		name='eopcheItemKey' 		value='0'/>";
