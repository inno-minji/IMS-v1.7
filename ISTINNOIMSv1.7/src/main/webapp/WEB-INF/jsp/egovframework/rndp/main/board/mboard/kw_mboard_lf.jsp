...
<script type="text/javascript">
	...
	function goViewImgDialogPopup(strImg, strSubj){
		...
		var str = "<img src='"+strImg+"' width='100%' height='100%' border='0' alt=''>";
...
<table style="width: 100%;">
	<tr>
		<td> 
		<table style="width: 100%;" class="board_list2" >
	            			...
	            			<table width="160" border="0" cellpadding="0" cellspacing="0">
	              			<tr>
	                			<td height="170" class="box">	
									<a href="javascript:javascript:goViewImgDialogPopup('/imageDownload.do?boardKey=${board.boardKey}&type=${boardmng.type}', '${board.subject }');">								
...
<c:if test="${strWriteAuth == 'T' || strWriteAuth == 'M' || strWriteAuth == 'A' }">
	...
	<img src="<c:url value='/images/images_btn/btn_write.gif'/>" align="absmiddle" border="0">
	</a>
</c:if>
</div>	
...
<!-- 보드 내용 끝 -->								
<div id="dialog" title="Basic dialog" style="display:none;border:1px solid;z-index:-1">
