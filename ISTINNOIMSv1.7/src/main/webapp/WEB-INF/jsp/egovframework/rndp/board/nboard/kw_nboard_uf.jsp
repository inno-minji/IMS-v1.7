...
<tr>
	<td>
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr height="35">
				<td align="right">						
					<input type="image" src="./images_smart/board/ok.gif" onclick="fn_update();" /> <!--확인 btn-->
					<a href="javascript:insert_reset();"><img src="./images_smart/board/cancle.gif" border="0" /></a> <!--취소 btn-->
					<a href="<c:url value='/webMenu.do'/>?key=${key}&pageGb=r"><img src="./images_smart/board/list.gif" border="0" /></a> <!--목록 btn-->
