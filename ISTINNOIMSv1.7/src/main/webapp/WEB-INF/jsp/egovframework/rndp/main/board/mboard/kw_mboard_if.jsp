	...
	<tr>
		<td>
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr height="35">
					<td align="right">						
						<input type="image" src="/images/images_btn/v_ok.gif" onclick="fn_insert();" /> <!--확인 btn-->
						<a href="javascript:insert_reset();"><img src="/images/images_btn/v_cancle.gif" border="0" /></a> <!--취소 btn-->
						<a href="<c:url value='/webMenu.do'/>?key=${key}"><img src="/images/images_btn/v_list.gif" border="0" /></a> <!--목록 btn-->
					</td>
				</tr>
			</table>
		</td>
