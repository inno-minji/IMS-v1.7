			...
			<tr>
				...
				<td width="760" valign="top">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<!-- 타이틀 -->	
							<td height="30" class="contents_title">${menuNm}</td>
						</tr>
						<tr>
							<td height="35"></td>
						</tr>
      ...
      <tr>
        <td><table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
              ...
              <!--저장 btn--><a href="javascript:goPasswordDialogPopup('u');"><img src="./images_smart/board/modify.gif" border="0" /></a> 
              <!--삭제 btn--><a href="javascript:goPasswordDialogPopup('d');"><img src="./images_smart/board/del.gif" border="0" /></a>
              </c:if>
              </c:otherwise>
              </c:choose>
              <c:if test="${strReplyAuth == 'T' || strReplyAuth == 'M' || strReplyAuth == 'A'}">
              <!--답글 btn--><a href="<c:url value='/webMenu.do'/>?key=${key}&boardKey=${boardUser.boardKey}&pageGb=c&depth=${boardUser.depth}"><img src="./images_smart/board/reply.gif" border="0" /></a>
              </c:if>
              <!--목록 btn--><a href="<c:url value='/webMenu.do'/>?key=${key}&pageGb=r"><img src="./images_smart/board/list.gif" border="0" /></a></td>
            </tr>
        </table></td>
      </tr>
    </table>							
...
<div id="dialog" title="Basic dialog" style="display:none;border:1px solid;">
		<form name="frm" id="frm" method="post" action="">
			<table width="100%">
				...
				<tr align="center" height="26">
					<td>
						<a href="javascript:goSubmit();"><img src="/images_in/k_write2.gif" /></a>
						<a href="javascript:goPasswordDialogClose();"><img src="/images_in/k_cancel.gif" border="0"/></a>
					</td>
				</tr>
			</table>
		</form>
