      ...
      <tr>
        <td><table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
              ...
              <!--저장 btn--><a href="javascript:goUpdate();"><img src="/images/images_btn/v_modify.gif" border="0" /></a> 
              <!--삭제 btn--><a href="javascript:goDelete('${key}','${boardUser.boardKey}','d','${boardmng.type}')"><img src="/images/images_btn/v_del.gif" border="0" /></a>
              </c:when>
              <c:otherwise>
              
	            <c:if test="${strWriteAuth == 'T' || strWriteAuth == 'A'|| strWriteAuth == 'M'|| strWriteAuth == 'S'}">
	              <a href="javascript:goPasswordDialogPopup('u');"><img src="<c:url value='/images/images_btn/v_modify.gif'/>" border="0" /></a> 
	              <a href="javascript:goPasswordDialogPopup('d');"><img src="<c:url value='/images/images_btn/v_del.gif'/>" border="0" /></a>   
	            </c:if>  
	          </c:otherwise>
              </c:choose>
              ...
              <img src="/images/images_btn/v_reply.gif" border="0" /></a>
              </c:if> --%>

              <a href="<c:url value='/webMenu.do'/>?key=${key}&pageGb=r&groupKey=${groupKey}"><img src="/images/images_btn/v_list.gif" border="0" /></a></td>
            </tr>
        </table></td>
      </tr>
    </table>							
...
<div id="dialog" title="Basic dialog" style="display:none;border:1px solid;">
	<form name="frm" id="frm" method="post" action="">
		<table width="100%">
			...
			<tr align="center" height="26">
				<td>
					<a href="javascript:goSubmit();"><img src="/images/images_btn/k_write2.gif" /></a>
					<a href="javascript:goPasswordDialogClose();"><img src="/images/images_btn/k_cancel.gif" border="0"/></a>
				</td>
			</tr>
		</table>
	</form>
