...
$(document).ready(function(){	
	var eGubunPage = "${mesMaintanceVO.eGubunPage}";
...
function mesIMGregInsert() {
	...
	$.ajax({  
		url: '/mes/maintance/popup/mesIMGregAddAjax.do'
	,	data : formData
	,	type : 'post'
    ,	dataType: 'JSON'
	,	contentType : false
...
<form id="frm" name="frm" method="post"  enctype="multipart/form-data"  action="/mes/maintance/popup/mesIMGregAdd_i.do">
	<div class="pop_head">
		<div id="pop_head">
			<div class="tit">
				<h3>첨부파일  추가</h3>
