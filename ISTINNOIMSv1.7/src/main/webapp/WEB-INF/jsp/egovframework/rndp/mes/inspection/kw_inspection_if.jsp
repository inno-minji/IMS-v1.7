...
<script type="text/javascript">
	...
	function insert_go(){
		    ...
		    var eInspectorOrg_worker = document.getElementById('eInspectorOrg_worker').value;
		    ...
		    if (!eInspectorOrg_worker) {
				modal1("작업자를 입력하세요.", "#eInspectorOrg_worker");
		        return false;
		    }
		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td>
						<div style="display: flex; align-items: center; gap: 10px;">
							<input type="text" id="eInspectorOrg_worker" name="eInspectorOrg" style="flex: 1; min-width: 0;" maxLength="50" />
							<a class="form_btn bg" onclick="selectWorkerPop('U', 'eInspectorOrg_worker')" style="margin-left: auto;">작업자 선택</a>
						</div>
